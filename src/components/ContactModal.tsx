            ...
            <DialogContent className="sm:max-w-[425px] lg:max-w-screen-md max-w-xs">
                <div className="lg:flex gap-10 items-center">
                    ...
                    <div className="lg:text-left text-center">
                        <DialogHeader>
                            <DialogTitle>¿Quieres llevar tu negocio al siguiente nivel?</DialogTitle>
                        </DialogHeader>
                        <h3 className="my-4">¡Tenemos la solución perfecta para ti!</h3>
                        <p className="text-sm text-muted-foreground my-4">
                        Optimiza cada aspecto de tu negocio con nuestras soluciones: desde la administración de ventas, gestión de inventario, hasta dispositivos de autoservicio y análisis de datos en tiempo real. 
                        </p>
